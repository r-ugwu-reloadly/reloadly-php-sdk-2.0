...
class UtilityPaymentsPayBillController extends BaseController
{
     ...
     * @param Models\ReloadlyUtilityPaymentsPayBillRequest $body Request Payload
     *
     * @return mixed Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function reloadlyUtilityPaymentsPayBill(
        string $accept,
        string $authorization,
        Models\ReloadlyUtilityPaymentsPayBillRequest $body
    ) {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri(Server::UTILITY_PAYMENTS) . '/pay';
