...
class GiftCardsCountriesController extends BaseController
{
     ...
     */
    public function reloadlyGiftCardsCountries(string $accept, string $authorization)
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri(Server::GIFT_CARDS) . '/countries';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function reloadlyGiftCardsCountryByIso(string $accept, string $authorization, string $countrycode)
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri(Server::GIFT_CARDS) . '/countries/{countrycode}';
