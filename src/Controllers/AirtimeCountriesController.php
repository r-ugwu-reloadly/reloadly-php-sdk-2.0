...
class AirtimeCountriesController extends BaseController
{
     ...
     */
    public function reloadlyAirtimeCountries(string $accept, string $authorization)
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri(Server::AIRTIME) . '/countries';
     ...
     * @param string $accept
     * @param string $authorization
     * @param string $countrycode The country's ISO Code.
     *
     * @return mixed Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function reloadlyAirtimeCountryByIso(string $accept, string $authorization, string $countrycode)
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri(Server::AIRTIME) . '/countries/{countrycode}';
