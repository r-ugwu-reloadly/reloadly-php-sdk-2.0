...
class UtilityPaymentsAccountBalanceController extends BaseController
{
     ...
     */
    public function reloadlyUtilityPaymentsAccountBalance(string $accept, string $authorization)
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri(Server::UTILITY_PAYMENTS) . '/accounts/balance';
